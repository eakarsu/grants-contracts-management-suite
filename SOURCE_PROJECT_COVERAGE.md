# Grants Contracts Management Suite Source Project Coverage

| Source Project | Routes | APIs | Prompt Files | Tool Files | Extracted Signals |
| --- | ---: | ---: | ---: | ---: | --- |
| government_contracts_v2 | 1 | 0 | 0 | 3 | search.js<br>About.tsx<br>AIAnalysisResults.tsx<br>AICenter.tsx<br>AICompetitorAnalyzer.tsx |
| AISmartContractAuditor | 8 | 9 | 1 | 2 | ai.ts<br>auditHistory.ts<br>audits.ts<br>auth.ts<br>complianceTemplates.ts |
