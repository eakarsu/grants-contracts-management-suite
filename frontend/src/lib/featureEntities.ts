...
const entitySeeds = [
  ...
  ["grant-draft","Grant Draft Records","Grant Draft operating queue","Open","Grant Draft follow-up list","Grant RFP Proposal","$0"],
  ["rfp-compliance-matrix","RFP Compliance Matrix Records","RFP Compliance Matrix operating queue","Review","RFP Compliance Matrix follow-up list","Grant RFP Proposal","$0"],
  ["proposal-submission-tracker","Proposal Submission Tracker Records","Proposal Submission Tracker operating queue","Review","Proposal Submission Tracker follow-up list","Grant RFP Proposal","$0"],
