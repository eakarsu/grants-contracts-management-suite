export const AUTH_COOKIE = 'grants_contracts_management_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@grants-contracts.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@grants-contracts.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@grants-contracts.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
