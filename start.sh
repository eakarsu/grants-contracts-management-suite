...
PORT="${PORT:-4730}"
DB_NAME="${PGDATABASE:-grants_contracts_management_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Grants Contracts Management Suite"
echo "======================================="
echo
...
echo "Starting grants contracts management suite frontend on http://localhost:$PORT"
echo "Login: admin@grants-contracts.local / admin123"
