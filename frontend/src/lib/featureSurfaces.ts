...
const featureSeeds = [
  ['grants', 'Grants', 'Grants operating queue', 'Programs Lead', 'Review and assign next action'],
  ['contracts', 'Contracts', 'Contracts operating queue', 'Programs Lead', 'Review and assign next action'],
  ['applicants', 'Applicants', 'Applicants operating queue', 'Programs Lead', 'Review and assign next action'],
  ['awards', 'Awards', 'Awards operating queue', 'Programs Lead', 'Review and assign next action'],
  ['budgets', 'Budgets', 'Budgets operating queue', 'Operations Lead', 'Review and assign next action'],
  ['milestones', 'Milestones', 'Milestones operating queue', 'Operations Lead', 'Review and assign next action'],
  ['subrecipients', 'Subrecipients', 'Subrecipients operating queue', 'Operations Lead', 'Review and assign next action'],
  ...
  ['amendments', 'Amendments', 'Amendments operating queue', 'Governance Lead', 'Review and assign next action'],
  ...
  ["grant-writing","Grant Writing","Grant Writing review queue","Grant RFP Proposal","Review source context and assign owner"],
  ["rfp-response","RFP Response","RFP Response review queue","Grant RFP Proposal","Confirm next action and update evidence"],
  ["sow-generator","SOW Generator","SOW Generator review queue","Grant RFP Proposal","Confirm next action and update evidence"],
  ["submission-tracker","Submission Tracker","Submission Tracker review queue","Grant RFP Proposal","Confirm next action and update evidence"],
  ["grant-draft","Grant Draft","Grant Draft workspace","Grant RFP Proposal","Review source evidence and assign owner"],
  ["rfp-compliance-matrix","RFP Compliance Matrix","RFP Compliance Matrix workspace","Grant RFP Proposal","Confirm findings, next action, and audit evidence"],
  ["proposal-submission-tracker","Proposal Submission Tracker","Proposal Submission Tracker workspace","Grant RFP Proposal","Confirm findings, next action, and audit evidence"],
