...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Grants Contracts Management Dashboard"
      subtitle="One merged grants contracts management view for Grants, Contracts, Applicants, Awards, Budgets, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared grants contracts management jobs into one surface. Grants, Contracts, Applicants, Awards, Budgets, Milestones, documents, audit, and AI are presented as platform features.</div>
